...
function Generator() {
  ...
  const qrCodeUrl =
    "https://api.qrserver.com/v1/create-qr-code/?" + qrCodeUrlParams.join("&");
  ...
  const downloadQrCode = async () => {
    ...
    const image = await axios
      .get(qrCodeUrl, { responseType: "blob" })
      .then(({ data }) => data);
    setBusy(false);
  ...
  return (
    <Flex flexDirection="column" gap={10}>
      ...
      <SimpleGrid columns={{ lg: 2 }} spacing={10}>
        <Flex as="form" flexDirection="column" gap={5} onSubmit={submitForm}>
          <FormControl>
          ...
          <FormControl isRequired>
            ...
            />
            <FormHelperText>
              Enter your virtual payment address e.g., {defaultVpa} etc.
            </FormHelperText>
          </FormControl>
          <FormControl>
            ...
            <FormHelperText>
              Enter any amount you want to collect with this QR code.
            </FormHelperText>
          </FormControl>
          <FormControl>
            ...
            />
            <FormHelperText>
              Enter any reference notes for payments with this QR code.
            </FormHelperText>
          </FormControl>
        ...
        >
          <Flex alignItems="center" flexDirection="column" gap={10}>
            ...
            <Flex alignItems="center" sx={{ gap: 3 }}>
              <Image src={paytmLogo} height={["1em", null, "1.5em"]} />
              <Image src={phonePeLogo} height={["1em", null, "1.5em"]} />
              <Image src={googlePayLogo} height={["1em", null, "1.5em"]} />
              <Image src={amazonPayLogo} height={["1em", null, "1.5em"]} />
            </Flex>
            <Text fontSize="sm">
              Generated from{" "}
              <Link href="https://arupmandal.me/">Arup Mandal</Link>
            </Text>
          </Flex>
        </Box>
      </SimpleGrid>
